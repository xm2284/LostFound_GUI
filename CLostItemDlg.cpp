...
IMPLEMENT_DYNAMIC(CLostItemDlg_7047, CDialogEx)

CLostItemDlg_7047::CLostItemDlg_7047(CWnd* pParent)
	: CDialogEx(IDD_LOST_ITEM_DLG, pParent), m_category_7047(0)
{
}

CLostItemDlg_7047::~CLostItemDlg_7047()
{
}

void CLostItemDlg_7047::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CLostItemDlg_7047, CDialogEx)
END_MESSAGE_MAP()

BOOL CLostItemDlg_7047::OnInitDialog()
{
